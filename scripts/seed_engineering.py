...
SKILLS = [
    ...
    ("Forging", "Metalwork", "Intermediate",
     "Shaping hot steel with a hammer — drawing it out, upsetting it, bending it, punching it — while it is soft enough to move and before it cools.",
     "Above about 900 °C steel deforms plastically at a fraction of its cold strength, and the grain flows with the shape rather than being cut across, which is why a forged part is stronger than a machined one. Every blow work-hardens the surface a little; the next heat recrystallises it. Scale forms as fast as the iron oxidises in air.",
     "Forge (gas or coal), anvil, 1–1.5 kg cross-pein hammer, tongs that fit the stock, a wire brush, a bucket of water for the tools not the work.",
     "Heat the stock to bright orange — yellow for heavy moving, never sparking white.\nWork fast: you have thirty seconds of good heat.\nTo draw out, hammer on the far edge of the anvil with half-on, half-off blows, rotating 90° each pass.\nTo upset, heat the end only and drive it back on itself, straightening as you go.\nBrush scale off before each heat.\nNormalise at the end: heat to red and cool in still air to reset the grain.",
     "Scale flies off hot; safety glasses always. Cotton, never synthetics. The forge is quiet and 1,200 °C; the anvil rebounds a missed blow.",
     "Cold shuts — folds hammered into the surface — from working too cold. Cracks from hammering a cold corner. Coarse, weak grain from soaking too long at yellow.",
     "The shape came from the metal moving, not from grinding; the surface has hammer marks and no cracks or folds; a cut face shows fine, even grain.",
     ["Fe", "C"], ["Young's Modulus", "Hooke's Law", "Newton's Law of Cooling"], []),
