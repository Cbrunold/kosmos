...
TARGETS = {
    "Spectral Types": {
        ...
        "title": "Name",
        "links": {
            "O-type Stars": ["Wien's Displacement Law", "Stefan–Boltzmann Law", "Planck's Law", "Chandrasekhar Limit", "Schwarzschild Radius"],
            "B-type Stars": ["Wien's Displacement Law", "Stefan–Boltzmann Law", "Rydberg Formula"],
            "A-type Stars": ["Rydberg Formula", "Bohr Model Energy Levels", "Wien's Displacement Law", "Chandrasekhar Limit"],
            "F-type Stars": ["Stefan–Boltzmann Law", "Wien's Displacement Law"],
            "G-type Stars": ["Stefan–Boltzmann Law", "Wien's Displacement Law", "Planck's Law", "Lawson Criterion", "Mass–energy equivalence", "Kirchhoff's Law of Thermal Radiation"],
            "K-type Stars": ["Wien's Displacement Law", "Stefan–Boltzmann Law"],
            "M-type Stars": ["Wien's Displacement Law", "Planck's Law", "Radioactive Decay Law"],
            "L-type Stars (L Dwarfs)": ["Planck's Law", "Wien's Displacement Law", "Fermi–Dirac Distribution"],
            "T-type Stars (T Dwarfs)": ["Planck's Law", "Wien's Displacement Law", "Boltzmann Distribution"],
            "Y-type Stars (Y Dwarfs)": ["Planck's Law", "Wien's Displacement Law", "Ideal Gas Law"],
        },
    },
    "Celestial Objects": {
    ...
    "Instruments": {
        ...
        "title": "Name",
        "links": {
            "Planck Satellite": ["Planck's Law", "Wien's Displacement Law", "First Friedmann Equation", "Hubble's Law", "Second Friedmann Equation"],
            "Chandra X-ray Observatory": ["Bragg's Law", "Schwarzschild Radius", "Chandrasekhar Limit", "Planck–Einstein Relation"],
            "Hubble Space Telescope (HST)": ["Hubble's Law", "Doppler Effect", "Gaussian Beam Divergence", "Chandrasekhar Limit"],
            "James Webb Space Telescope (JWST)": ["Wien's Displacement Law", "Planck's Law", "Hubble's Law", "Diffraction Grating Equation"],
            ...
            "Large Synoptic Survey Telescope (LSST)": ["Hubble's Law", "Chandrasekhar Limit", "Bayes' Theorem", "Normal Distribution", "Kepler's Third Law"],
        },
    },
    "Theories": {
