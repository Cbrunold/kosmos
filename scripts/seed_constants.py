...
CONST_EQUATIONS = {
    ...
    "T₀": ["Planck's Law", "Wien's Displacement Law", "Cosmological Redshift"],
    "ρ_c": ["First Friedmann Equation", "Critical Density"],
    "Ω_m": ["Critical Density", "Second Friedmann Equation"],
    "Ω_Λ": ["Critical Density", "Second Friedmann Equation"],
