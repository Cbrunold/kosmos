...
CONST_EQUATIONS = {
    "c": ["Mass–energy equivalence", "Lorentz Factor", "Lorentz Transformations", "Einstein Field Equations",
          ...
          "Ampère–Maxwell Law", "Gravitational Time Dilation", "Chandrasekhar Limit"],
    ...
    "m_e": ["Drude Conductivity", "Plasma Frequency", "Bohr Model Energy Levels", "London Equations",
            "Compton Wavelength" if False else "De Broglie Wavelength"],
    "m_p": ["Chandrasekhar Limit"],
    "R_∞": ["Rydberg Formula", "Bohr Model Energy Levels"],
    ...
    "pc": ["Hubble's Law"],
    "H₀": ["Hubble's Law", "First Friedmann Equation", "Second Friedmann Equation"],
    "T₀": ["Planck's Law", "Wien's Displacement Law"],
    "ρ_c": ["First Friedmann Equation"],
    "g₀": ["Specific Impulse"],
