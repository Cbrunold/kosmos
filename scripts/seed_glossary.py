...
TERMS = [
    ...
    ("Curvature", "Mathematics", "How sharply a curve or surface bends: one over the radius of the circle that best fits it there. Straight lines have none. In general relativity it is what gravity is — matter tells spacetime how to curve.", "curved"),
    ...
    ("Cut angle", "Cue sports", "The angle between the cue ball's path and the line of centres at contact — zero for a straight-in shot, 30° for a half-ball hit. It sets how the speed and energy divide between the two balls.", ""),
